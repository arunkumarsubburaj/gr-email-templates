(window["amFomo_jsonp"] = window["amFomo_jsonp"] || []).push([
  [1],
  {
    /***/ bdd8: /***/ function(
      module,
      ...
      const ThemeOne = () =>
        __webpack_require__
          .e(/* import() | signup-theme-1 */ 2)
          .then(__webpack_require__.bind(null, "5803"));

      const ThemeTwo = () =>
        __webpack_require__
          .e(/* import() | signup-theme-2 */ 3)
          .then(__webpack_require__.bind(null, "3851"));
      ...
      /* harmony default export */ var Signupvue_type_script_lang_js_ = {
        ...
        computed: {
          screen: function() {
            if (this.previewMode) return this.details.show_screen;
      ...
      /* harmony default export */ var Signup = (__webpack_exports__[
        "default"
      ] = component.exports);
