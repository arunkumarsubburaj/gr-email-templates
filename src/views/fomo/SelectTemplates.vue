<template>
  <div class="changeTemplateView">
    ...
    <div class="fomo_inner_block">
              ...
              <div class="template-inner">
                  <div :class="'template-inner-' + template.id">
                      <div :class="'template-inner-' + template.id + '-inner'">
                          <md-icon class="btn-close" v-if="template.btnClose !== ''">{{template.btnClose}}</md-icon>
                          <a v-if="template.linkClose !== ''" href="#" class="link-close">{{template.linkClose}}</a>
                          <p v-if="template.subTitle !== ''">{{template.subTitle}}</p>
                          <h3 v-if="template.title !== ''">{{template.title}}</h3>
                          <p v-if="template.desc !== ''">{{template.desc}}</p>
                          <a v-if="template.btnSignup !== ''" href="#" class="btn">{{template.btnSignup}}</a>
      ...
      <p class="upcomingTemplate">Keep an eye for the upcoming templates... We will roll out soon!</p>
  </div>
  </div>
</template>
<script>
    ...
    data: function () {
      return {
        ...
        templates: [
          ...
          {id: '2', subTitle: 'Hi FRIEND,', title: 'Sign up now to get welcome points!', desc: '', btnSignup:'', count: '100', countDesc: 'welcome points', btnClose: '', linkClose: 'Close'},
          {id: '3', subTitle: 'Hi FRIEND,', title: 'Sign up now to get exicting offers!', desc: '', btnSignup:'Sign up', count: '', countDesc: '', btnClose: 'close', linkClose: ''},
          {id: '4', subTitle: '', title: 'HEY FRIEND!', desc: 'Sign up now and explore exiciting deals during this festive seasons', btnSignup:'Sign up now', count: '', countDesc: '', btnClose: '', linkClose: 'Close'},
          {id: '5', subTitle: '', title: 'New to [[website_Name]]?', desc: 'Sign up now and explore exclusive deals for this festive seasons', btnSignup:'Sign up now', count: '', countDesc: '', btnClose: 'close', linkClose: ''},
          {id: '6', subTitle: '', title: 'CONGRATULATIONS!', desc: 'Sign up and explore exiciting deals + Coupon', btnSignup:'GRCOUPON', count: '', countDesc: '', btnClose: 'close', linkClose: ''}
        ],
      };
    },
...
<style lang="less" scoped>
  ...
  /* Template 4 */
  .template-inner-4 {
    background-image: linear-gradient(-35deg, rgba(255,75,116,1) 0%, rgba(121,52,64,1) 80%, rgba(121,52,64,1) 100%);
    bottom: 40px;
    width: 220px;
    position: absolute;
    border-radius: 50%;
    ...
    .template-inner-4-inner {
      ...
      background-image: linear-gradient(-35deg, rgba(255,75,116,0) 0%, rgba(75,42,138,1) 55%, rgba(75,42,138,1) 100%);
      padding: 35px 10px;
      width: 200px;
      border-radius: 50%;
      height: 200px;
  ...
  .template-inner-6 {
    ...
    .btn {
      background: #f3e374 url(../../assets/fomo/bg_scratch.png) no-repeat center center;
